    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link to="/auth/register" className="bg-primary hover:bg-primary-dark text-white px-8 py-4 rounded-md font-semibold whitespace-nowrap transition-colors">
                Start Sourcing
              </Link>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="w-16 h-16 bg-primary-light rounded-lg flex items-center justify-center mb-6">
                <i className="ri-price-tag-3-line text-3xl text-primary"></i>
              </div>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-primary-light">Join thousands of buyers who trust our platform</p>
          <Link to="/auth/register" className="bg-white hover:bg-gray-100 text-primary px-10 py-4 rounded-md font-semibold whitespace-nowrap transition-colors inline-block">
            Create Free Account
          </Link>
        </div>
      </section>
